...
// the rest of its ten minutes (ADR 0030).
...
func (b *takingBuiltins) Take(_ context.Context, _, _ string, step *dholev1.Step, _ uint32) (bool, error) {
...
// a plane worker takes it or a gate is armed (ADR 0030).
